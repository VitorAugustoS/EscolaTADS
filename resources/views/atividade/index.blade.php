...
<main id="main" data-aos="fade-in">
    ...
    <div class="container">
      <form action="/atividade" method="post" class="row">
        ...
        <div class="form-group col-6">
          ...
          <input type="text" name="valor" id="valor" class="form-control" value="{{ $atividade->valor }}" />
        </div>

        <div class="form-group col-6">
          <label for="data">Data:</label>
          <input type="date" name="data" id="data" class="form-control" value="{{ $atividade->data }}" />
        </div>

        <div class="form-group col-6">
          @csrf
          <input type="hidden" id="id" name="id" value="{{ $atividade->id }}" />
          <a href="/atividade" class="btn btn-primary" style="margin-top: 23px;">
